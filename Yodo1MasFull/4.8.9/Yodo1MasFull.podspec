...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.9/iOS/Release/Yodo1MasFull-4.8.9.zip' }
s.xcconfig = {
"OTHER_LDFLAGS" => "-ObjC",
...
s.dependency 'Yodo1MasMediationFyber', '4.8.9'
# s.dependency 'Yodo1MasMediationIronSource', '4.8.9'
s.dependency 'Yodo1MasMediationFacebook', '4.8.9'
s.dependency 'Yodo1MasMediationInMobi', '4.8.9'
s.dependency 'Yodo1MasMediationMintegral', '4.8.9'
s.dependency 'Yodo1MasMediationMyTarget', '4.8.9'
s.dependency 'Yodo1MasMediationPangle', '4.8.9'
s.dependency 'Yodo1MasMediationTencent', '4.8.9'
s.dependency 'Yodo1MasMediationUnityAds', '4.8.9'
s.dependency 'Yodo1MasMediationVungle', '4.8.9'
s.dependency 'Yodo1MasMediationYandex', '4.8.9'
s.dependency 'Yodo1MasMediationYodo1', '4.8.9'
end
